...
pub use auth::{login, register, google_authorize, google_callback, github_authorize, github_callback, apple_authorize, apple_callback, facebook_authorize, facebook_callback};
